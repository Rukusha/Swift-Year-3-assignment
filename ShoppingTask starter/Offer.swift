...
protocol Offer {
    ...
    /**
     ...
     - Parameter purchases: An array of Product objects
     - Returns:
...
/**
 ...
 The discount should be calculated on a per product basis, e.g. for a 50% discount, the discount on two products each costing 99p should be 98p (e.g. one product discount is (99p * 0.5) = 49p)
 */
protocol DiscountedPriceOffer : SimpleOffer {
    
    /**
    *Represents the percentage discount applied, e.g. 0.5 is 50%*
...
protocol CappedOffer : SimpleOffer {
    ...
    /**How many products need to be purchased for the offer to apply
     */
